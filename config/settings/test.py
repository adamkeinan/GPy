...
class CacheTestSuite(unittest.TestCase):
    ...
    def test_redis_multi_location_parsing(self):
        ...
        self.assertEqual(
            url["LOCATION"],
            ["redis://host1:6379/1", "redis://host2:6379/1", "redis://host3:9999/1",],
        )
    ...
    def test_options_parsing(self):
        ...
        self.assertEqual(url["OPTIONS"], {"MAX_ENTRIES": 1000, "CULL_FREQUENCY": 0,})
    ...
    def test_unknown_backend(self):
        ...
        self.assertEqual(str(cm.exception), "Invalid cache schema unknown-scheme")
